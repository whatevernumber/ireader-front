...
<search>
    <AutoComplete placeholder="Сегодня я прочитал(а)..." searchFunction={getOptions} bind:selectedItem="{selectedBook}" delay="400" hideArrow inputClassName="input input-bordered input-warning mr-1 {type === 'main' ? 'h-16  sm:w-[200px] md:w-[300px] lg:w-[500px]' : 'sm:w-[200px] xl:w-[350px]'}"
